...
<article id="bo_v" style="width: 100%">
	...
	<section id="bo_v_info">
		<h2>페이지 정보</h2>작성자 <strong><span class="sv_member">${videoData.VIDEO_WRITER}</span></strong> 
		<span class="sound_only">작성일</span><strong>${videoData.VIDEO_INSERT_DATE}</strong> 조회 <strong>${videoData.VIDEO_CLICK_COUNT} 회
	</section>
	...
	<section id="bo_v_atc">
		...
		<div id="bo_v_img">
			<video width="100%" height="100%" controls="controls" class="video-js vjs-default-skin" data-setup="{}">
